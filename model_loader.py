...
The script will prompt for the required fields (pl_radj, pl_orbper, pl_trandur, depth,
st_teff, st_logg, st_rad, koi_kepmag). Optional fields: pl_eqt or pl_insol (you may
leave them empty and the script will try to derive simple proxies).

Notes:
- Expects model files in models/v1/ produced by your training scripts:
  stacking_model.pkl, global_scaler.pkl, num_imputer.pkl, feature_list.pkl
