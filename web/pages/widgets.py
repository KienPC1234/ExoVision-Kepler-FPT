...
scc.embed_iframe("http://103.252.0.76/iframe/plant_preview/",height=300)
...
with tabs[0]:
    ...
    st.page_link("web/pages/widgets.py", label="Page link (this page)", icon=":material/my_location:")
    st.page_link("web/pages/text.py", label="Page link (next page)", icon=":material/skip_next:")
